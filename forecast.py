...
def print_error_metrics(y_test, y_hat, rescaled_y_test, rescaled_y_hat):
    ...
    print("error_metrics:________________")
...
def run(args):
    ...
    print("print_error_metrics_________")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str, default='/home/hfut3304/data/workspace/SXS/GTM-Transformer-main/log/GTM/GTM_Run1---epoch=4---26-09-2024-10-33-02.ckpt')
