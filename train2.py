...
def run(args):
    ...
    # # Replace with TensorBoard Logger or other:
    # tb_logger = pl_loggers.TensorBoardLogger(args.log_dir + '/', name=model_savename)
    #
    # # Then use the TensorBoard logger in Trainer:
    # trainer = pl.Trainer(gpus =[0, 1, 2], max_epochs=args.epochs, check_val_every_n_epoch=5,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='FCM', help='Choose between GTM or FCN')
    ...
    parser.add_argument('--wandb_proj', type=str, default='FCM')
